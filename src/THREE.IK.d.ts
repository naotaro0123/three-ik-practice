...
// import { transformPoint, getCentroid, getWorldPosition, setQuaternionFromDirection, IKJoint, IKConstraint } from 'three-ik';
...
// export interface BoneHelper {
//   height: number;
//   boneSize: number;
//   axesSize: number;
// }

// export interface IKHelper {
//   ik: IK;
//   config: {
//     color: Color,
//     showBones: boolean,
